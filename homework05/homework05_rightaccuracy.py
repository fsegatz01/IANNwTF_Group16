# -*- coding: utf-8 -*-
"""homework05_rightAccuracy.ipynb
...
class BasicConv(tf.keras.Model):
    def __init__(self):
        ...
        self.optimizer = tf.keras.optimizers.Adam(learning_rate=0.005) # optimizer Adam
...
def training(opt):
  ...
  def training_loop(model, train_ds, test_ds, epochs, train_summary_writer, test_summary_writer, save_path=False): 
...
training(tf.keras.optimizers.Adam())
